...
QT_MOC_LITERAL(1, 12, 21), // "twoFactorAuthRequired"
QT_MOC_LITERAL(2, 34, 0), // ""
QT_MOC_LITERAL(3, 35, 7), // "adminId"
QT_MOC_LITERAL(4, 43, 17), // "permissionChanged"
QT_MOC_LITERAL(5, 61, 8), // "username"
QT_MOC_LITERAL(6, 70, 8) // "resource"

    },
    "AuthManager\0twoFactorAuthRequired\0\0"
    "adminId\0permissionChanged\0username\0"
    "resource"
};
...
void AuthManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->twoFactorAuthRequired((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: _t->permissionChanged((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            typedef void (AuthManager::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AuthManager::twoFactorAuthRequired)) {
                *result = 0;
            }
        }
        {
            typedef void (AuthManager::*_t)(const QString & , const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AuthManager::permissionChanged)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject AuthManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_AuthManager.data,
      qt_meta_data_AuthManager,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
// SIGNAL 0
void AuthManager::twoFactorAuthRequired(const QString & _t1)
{
...
// SIGNAL 1
void AuthManager::permissionChanged(const QString & _t1, const QString & _t2)
{
